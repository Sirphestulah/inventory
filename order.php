		...
		<div class="col-lg-12">
			...
			<div class="panel panel-default">
                ...
                <div class="panel-body">
                	<table id="order_data" class="table table-bordered table-striped table-responsive w-100 d-block d-md-table" style="width:100%;">
                		<thead>
							<tr>
								<th>Order ID</th>
								<th>Customer Name</th>
    		...
    		<form method="post" id="order_form">
    			<div class="modal-content">
    				...
    				<div class="modal-body">
    					<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label>Enter Receiver/Customer Name</label>
						...
						<div class="form-group">
							<label>Enter Receiver/Customer Address</label>
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		$('#add_button').click(function(){
			...
			$('#order_form')[0].reset();
			$('.modal-title').html("<i class='fa fa-plus'></i> Create New Order");
			$('#action').val('Add');
			$('#btn_action').val('Add');
