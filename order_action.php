...
if(isset($_POST['btn_action']))
{
	...
	{
		$query = "
		INSERT INTO inventory_order (user_id, inventory_order_total, inventory_order_date, inventory_order_name, inventory_order_address, payment_status, inventory_order_status, inventory_order_created_date, inventory_order_created_time) 
		VALUES (:user_id, :inventory_order_total, :inventory_order_date, :inventory_order_name, :inventory_order_address, :payment_status, :inventory_order_status, :inventory_order_created_date,:inventory_order_created_time)
		";
		...
		$statement->execute(
			array(
				...
				':inventory_order_created_time' => date("h:i:sa")
			)
		);
		...
		if(isset($inventory_order_id))
		{
			...
			for($count = 0; $count<count($_POST["product_id"]); $count++)
			{
				...
				$sub_query = "
				INSERT INTO inventory_order_product (inventory_order_id, product_id, quantity, price, tax,inv_date) VALUES (:inventory_order_id, :product_id, :quantity, :price, :tax , :inv_date)
				";
