...
if(isset($_POST["search"]["value"]))
{
	...
	$query .= 'OR payment_status LIKE "%'.$_POST["search"]["value"].'%") ';
}
...
foreach($result as $row)
{
	...
	{
		$payment_status = '<span class="label label-warning">Bank Transfer</span>';
	}
	...
	if($_SESSION['type'] == 'user')
	{
	$sub_array[] = '<a href="me.php?pdf=1&order_id='.$row["inventory_order_id"].'" class="btn btn-info btn-xs">Print</a>';
	}
	if($_SESSION['type'] == 'master')
	{
