...
foreach($result as $row)
{
	...
	if(available_product_quantity($connect, $row["product_id"])<=10)
	{
		$quan= "<p align='center' style='color:red; font-weight:bold;'>Alert</p>";	
	}
	else{
		$quan= "<p align='center' style='color:green; font-weight:bold;'>Enough</p>";	
	}
	$sub_array[] = $quan;
